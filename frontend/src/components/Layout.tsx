...
import {Calendar, ChevronRight, Database, FileStack, MessageSquare, Moon, Network, Settings, Sparkles, Sun, Users,} from 'lucide-react';
  ...
  const navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'knowledge-graph', path: '/knowledgegraph', label: '知识图谱', icon: Network, description: '可视化知识点关系' },
      ],
    },
    {
      id: 'system',
